...
const sidebars = {
  ...
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: [
        '02_Interface_et_ligne_de_commande/00_Intéragir_avec_la_ligne_de_commande',
        '02_Interface_et_ligne_de_commande/01_Exerice_guidé_Intéragir_avec_la_ligne_de_commande',
        '02_Interface_et_ligne_de_commande/02_Examen_des_ressources_Kubernetes',
        '02_Interface_et_ligne_de_commande/03_Exercice_guidé_Examen_des_ressources_Kubernetes',
        '02_Interface_et_ligne_de_commande/04_Résumé',
      ],
    },
    {
      type: 'category',
    ...
    },
    {
      ...
      items: [
        '06_Configuration_de_la_fiabilité_des_applications/00_Utilisation_des_probes_dans_Kubernetes',
        '06_Configuration_de_la_fiabilité_des_applications/01_Exercice_guidé_Utilisation_des_probes_dans_Kubernetes',
        ...
        '06_Configuration_de_la_fiabilité_des_applications/04_Mise_a_l_echelle_automatique_des_applications',
    ...
    },
    {
      ...
      items: [
        ...
        '07_Gestion_et_administration_du_cluster/05_Exercice_guidé_MachineSet_MachineConfigs.md',
